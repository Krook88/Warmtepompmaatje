/* ==========================================================================
   ...
   Gebruik: Iconen.svg("warmte") geeft de markup terug. In statische HTML
...
(function (root, factory) {
  ...
  const PADEN = {
    // Warmtepompmaatje-specifiek. De rest van deze set is gelijk aan die van
    // de zustersites, zodat een icoon overal hetzelfde betekent.
    "warmte": '<path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4" />',
    "stil": '<path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" /> <path d="m22 9-6 6" /> <path d="m16 9 6 6" />',
